      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="bg-slate-900/70 backdrop-blur border border-slate-800 rounded-xl shadow-lg p-6 sm:p-8 hover:shadow-xl transition-shadow">
            ...
            <p className="text-sm sm:text-base text-slate-400 mb-3 sm:mb-4">Official RVCE Placement Email</p>
            <a
          ...
          <div className="bg-slate-900/70 backdrop-blur border border-slate-800 rounded-xl shadow-lg p-6 sm:p-8 hover:shadow-xl transition-shadow">
            ...
            <p className="text-sm sm:text-base text-slate-400 mb-3 sm:mb-4">Visit the official RVCE Placement website</p>
            <a
        ...
        <div className="bg-slate-900/70 backdrop-blur border border-slate-800 rounded-xl shadow-lg p-6 sm:p-8">
          <h3 className="text-lg sm:text-xl font-semibold text-indigo-400 mb-3 sm:mb-4">RV College of Engineering</h3>
          <p className="text-sm sm:text-base text-slate-300 mb-2">
            <strong className="text-white">Address:</strong> RV Vidyaniketan Post, Mysore Road, Bengaluru - 560059, Karnataka, India
          </p>
